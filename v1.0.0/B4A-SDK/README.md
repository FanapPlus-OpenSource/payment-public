...
You can use this android library when you want to have an application without using app-compat. For example, in Basic4Android you need to use this library.
